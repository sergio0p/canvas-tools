...
MWF_DATES = ['2025-08-22', '2025-08-25', '2025-08-27', '2025-08-29',
...
def create_group_with_slots(date_str):
    ...
    new_appointments = []
    for i in range(4):  # 4 slots: 13:00, 13:15, 13:30, 13:45
        start = (day + timedelta(minutes=13*60 + i*15)).isoformat()
        end = (day + timedelta(minutes=13*60 + (i+1)*15)).isoformat()
